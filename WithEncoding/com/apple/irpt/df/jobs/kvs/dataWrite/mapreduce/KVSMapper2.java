...
public class KVSMapper2 extends Mapper<LongWritable, Text, Text, NullWritable> {
    ...
    private static final String UNMAPPED_KEY = "Unmappedkey";
    public static final String FULL_ENCODED_DATA = "FullEncodedData";
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        for (Path eachPath : cacheFilesLocal) {
            if (eachPath.getName().trim().equals(UNMAPPED_KEY)) {
               ...
               // loadMappingHashMap(new Path("/Users/keshav/Documents/20150616/KvsAggregatorWithEncoding_new/out1/Unmappedkey/-r-00000"));
                loadMappingHashMap(new Path(eachPath.toString()+"/-r-00009"));
            }
        }
    }
